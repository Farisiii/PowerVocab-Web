...
import { LogoutModal } from '@/components/home/common/logout-modal'
    ...
    <>
      ...
      >
        ...
        >
          <Button
            variant="ghost"
            className="w-full justify-start gap-4 text-red-400 hover:text-red-600 hover:bg-red-50 h-12 rounded-2xl cursor-pointer"
